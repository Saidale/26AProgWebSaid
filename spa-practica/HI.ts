...
let bx = createInjectorButton(
  "Inyectar HTML",
  "<p><strong>¡HTML inyectado!</strong></p>",
  button3
);

createInjectorButton(
  "2 Inyectar HTML",
  "<div style='background-color: #FF0000; padding: 20px;'>Este div tiene un fondo rojo.</div>",
  bx
);

createInjectorButton(
  "Página Azul",
  "<p style='background-color: blue; padding: 20px; color: white;'>Contenido Azul</p>",
  button3
);

createInjectorButton(
  "Página Roja",
  "<div style='background-color: red; padding: 20px;'>Contenido Rojo</div>",
  button3
);